resource "aws_cloudfront_origin_access_identity" "public-cf-identity" { }
...
resource "aws_cloudfront_distribution" "public-cf" {
  ...
  origin {
    ...
    s3_origin_config {
      origin_access_identity = "${aws_cloudfront_origin_access_identity.public-cf-identity.cloudfront_access_identity_path}"
    }
  }
