...
locals {
  ...
  public-domain = "img.exampleapp.com"

  web-origin-domain ="web01.exampleapp.com"
  web-domain = ["exampleapp.com", "www.exampleapp.com"]

  app-domain = ["ec.exampleapp.com"]
  ...
  deploy-target-arn = "arn:aws:s3:::prod-deploy-2312321341368924djklsfjh3" # TODO: arn変更
